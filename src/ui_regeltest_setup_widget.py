...
class Ui_RegeltestSetup_Rulegroup(object):
    ...
    def retranslateUi(self, RegeltestSetup_Rulegroup):
        ...
        self.label_rulegroup.setText(QCoreApplication.translate("RegeltestSetup_Rulegroup", u"01 - Das Spielfeld", None))
        self.label_2.setText(QCoreApplication.translate("RegeltestSetup_Rulegroup", u"Textquestion", None))
